-- Generated by ebean unknown at 2021-08-22T03:33:37.079509Z
...
create table bar (
  ...
  bar_id                        integer generated by default as identity not null,
...
create table app_config_control (
  id                            integer generated by default as identity not null,
  name                          varchar(255),
  config_id                     integer,
  constraint pk_app_config_control primary key (id)
);
...
create table bsite_user_d (
  ...
  constraint pk_bsite_user_d primary key (site_id,user_id)
);

create table bsite_user_dmany (
  site_id                       uuid not null,
  user_id                       uuid not null,
  name                          varchar(255) not null,
  many                          varchar(255),
  version                       bigint not null,
  constraint pk_bsite_user_dmany primary key (site_id,user_id,name)
);
...
create table calcd_data (
  id                            integer generated by default as identity not null,
  name                          varchar(255),
  constraint pk_calcd_data primary key (id)
);

create table calcd_input (
  id                            integer generated by default as identity not null,
  name                          varchar(255),
  constraint pk_calcd_input primary key (id)
);
...
create table class_super (
  ...
  sid                           bigint generated by default as identity not null,
...
create table ebasic_json_jackson3 (
  id                            bigint generated by default as identity not null,
  name                          varchar(255),
  plain_value                   varchar(500),
  plain_value2                  varchar(500),
  plain_value3                  varchar(500),
  version                       bigint not null,
  constraint pk_ebasic_json_jackson3 primary key (id)
);
...
create table ebasic_json_multi (
  id                            bigint generated by default as identity not null,
  name                          varchar(255),
  plain_value1                  varchar(500),
  plain_value2                  varchar(500),
  plain_value3                  varchar(500),
  version                       bigint not null,
  constraint pk_ebasic_json_multi primary key (id)
);
...
create table ebasic_old_value (
  ...
  json_node                     clob,
  string_arr                    array,
  constraint pk_ebasic_old_value primary key (id)
);

create table ebasic_plain (
  id                            bigint generated by default as identity not null,
  attr                          varchar(255),
  plain_bean                    varchar(500),
  plain_bean2                   varchar(500),
  version                       bigint not null,
  constraint pk_ebasic_plain primary key (id)
);
...
create table esimple (
  usertypeid                    integer generated by default as identity not null,
  name                          varchar(255),
...
create table esoft_del_x (
  id                            uuid not null,
  y_id                          bigint,
  organization_id               bigint,
  deleted                       boolean default false not null,
  constraint uq_esoft_del_x_y_id unique (y_id),
  constraint pk_esoft_del_x primary key (id)
);

create table esoft_del_y (
  id                            bigint generated by default as identity not null,
  organization_id               bigint,
  deleted                       boolean default false not null,
  constraint pk_esoft_del_y primary key (id)
);

create table esoft_del_z (
  id                            bigint generated by default as identity not null,
  uuid                          uuid,
  deleted                       boolean default false not null,
  constraint pk_esoft_del_z primary key (id)
);
...
create table td_parent (
  ...
  parent_id                     integer generated by default as identity not null,
...
create table foo (
  foo_id                        integer generated by default as identity not null,
...
create table hembi_bean (
  part                          bigint not null,
  brand                         varchar(20) not null,
  name                          varchar(255),
  description                   varchar(255),
  version                       bigint not null,
  constraint pk_hembi_bean primary key (part,brand)
);
...
create table monkey (
  mid                           bigint generated by default as identity not null,
  name                          varchar(255),
...
create table mny_edge (
  id                            integer generated by default as identity not null,
  from_id                       integer,
  to_id                         integer,
  flags                         integer not null,
  constraint uq_mny_edge_from_id_to_id unique (from_id,to_id),
  constraint uq_mny_edge_to_id_from_id unique (to_id,from_id),
  constraint pk_mny_edge primary key (id)
);

create table mny_node (
  id                            integer generated by default as identity not null,
  name                          varchar(255),
  constraint pk_mny_node primary key (id)
);
...
create table ms_many_a (
  aid                           bigint generated by default as identity not null,
  name                          varchar(255),
...
create table ms_many_b (
  bid                           bigint generated by default as identity not null,
  name                          varchar(255),
  deleted                       boolean default false not null,
...
create table om_bean_list_child (
  id                            bigint generated by default as identity not null,
  name                          varchar(255),
  parent_id                     bigint,
  version                       bigint not null,
  constraint pk_om_bean_list_child primary key (id)
);

create table om_bean_list_parent (
  id                            bigint generated by default as identity not null,
  version                       bigint not null,
  constraint pk_om_bean_list_parent primary key (id)
);
...
create table oto_bchild (
  master_id                     bigint generated by default as identity not null,
  child                         varchar(255),
...
create table oto_prime_extra (
  eid                           bigint generated by default as identity not null,
  extra                         varchar(255),
  version                       bigint not null,
...
create table parcel (
  parcelid                      bigint generated by default as identity not null,
  description                   varchar(255),
  constraint pk_parcel primary key (parcelid)
);

create table parcel_location (
  parcellocid                   bigint generated by default as identity not null,
  location                      varchar(255),
  parcelid                      bigint,
...
create table person_other (
  ...
  when_modified                 timestamp not null,
  version                       bigint not null,
  constraint pk_person_other primary key (id)
);
...
create table app_config_re (
  id                            integer generated by default as identity not null,
  config_id                     integer,
  constraint pk_app_config_re primary key (id)
);
...
create table root_bean (
  dtype                         varchar(31) not null,
  id                            uuid not null,
  referencing_bean_id           uuid not null,
  value                         varchar(255),
...
create table self_many_many (
  id                            bigint generated by default as identity not null,
  name                          varchar(255),
  constraint pk_self_many_many primary key (id)
);

create table self_many_bridge (
  self_1_id                     bigint not null,
  self_2_id                     bigint not null,
  constraint pk_self_many_bridge primary key (self_1_id,self_2_id)
);
...
create table sub_type (
  sub_type_id                   integer generated by default as identity not null,
  description                   varchar(255),
  version                       bigint not null,
...
create table test_jakarta_annotation_base_entity (
  direct                        varchar(255),
  meta                          varchar(255),
  mixed                         varchar(255),
  constraint_annotation         varchar(40),
...
create index ano_1 on test_jakarta_annotation_base_entity (direct);
create index ano_2 on test_jakarta_annotation_base_entity (direct);
...
create index ix_app_config_control_config_id on app_config_control (config_id);
alter table app_config_control add constraint fk_app_config_control_config_id foreign key (config_id) references app_config (id) on delete restrict on update restrict;
...
create index ix_bsite_user_dmany_bsite_user_d on bsite_user_dmany (site_id,user_id);
alter table bsite_user_dmany add constraint fk_bsite_user_dmany_bsite_user_d foreign key (site_id,user_id) references bsite_user_d (site_id,user_id) on delete restrict on update restrict;
...
alter table calcd_data add constraint fk_calcd_data_id foreign key (id) references calcd_input (id) on delete cascade on update restrict;
...
alter table dfk_cascade add constraint fk_dfk_cascade_one_id foreign key (one_id) references dfk_cascade_one (id) on delete cascade on update restrict;

create index ix_dfk_set_null_one_id on dfk_set_null (one_id);
alter table dfk_set_null add constraint fk_dfk_set_null_one_id foreign key (one_id) references dfk_one (id) on delete set null on update restrict;
...
alter table esoft_del_x add constraint fk_esoft_del_x_y_id foreign key (y_id) references esoft_del_y (id) on delete restrict on update restrict;

create index ix_esoft_del_x_organization_id on esoft_del_x (organization_id);
alter table esoft_del_x add constraint fk_esoft_del_x_organization_id foreign key (organization_id) references esoft_del_z (id) on delete restrict on update restrict;

create index ix_esoft_del_y_organization_id on esoft_del_y (organization_id);
alter table esoft_del_y add constraint fk_esoft_del_y_organization_id foreign key (organization_id) references esoft_del_z (id) on delete restrict on update restrict;
...
create index ix_mny_edge_from_id on mny_edge (from_id);
alter table mny_edge add constraint fk_mny_edge_from_id foreign key (from_id) references mny_node (id) on delete restrict on update restrict;

create index ix_mny_edge_to_id on mny_edge (to_id);
alter table mny_edge add constraint fk_mny_edge_to_id foreign key (to_id) references mny_node (id) on delete restrict on update restrict;
...
create index ix_om_bean_list_child_parent_id on om_bean_list_child (parent_id);
alter table om_bean_list_child add constraint fk_om_bean_list_child_parent_id foreign key (parent_id) references om_bean_list_parent (id) on delete restrict on update restrict;
...
create index ix_app_config_re_config_id on app_config_re (config_id);
alter table app_config_re add constraint fk_app_config_re_config_id foreign key (config_id) references app_config (id) on delete restrict on update restrict;
...
create index ix_self_many_bridge_self_many_many_1 on self_many_bridge (self_1_id);
alter table self_many_bridge add constraint fk_self_many_bridge_self_many_many_1 foreign key (self_1_id) references self_many_many (id) on delete restrict on update restrict;

create index ix_self_many_bridge_self_many_many_2 on self_many_bridge (self_2_id);
alter table self_many_bridge add constraint fk_self_many_bridge_self_many_many_2 foreign key (self_2_id) references self_many_many (id) on delete restrict on update restrict;
...
alter table hembi_bean add column sys_period_start timestamp default now();
alter table hembi_bean add column sys_period_end timestamp;
create table hembi_bean_history(
  part                          bigint,
  brand                         varchar(20),
  name                          varchar(255),
  description                   varchar(255),
...
create view hembi_bean_with_history as select * from hembi_bean union all select * from hembi_bean_history;

alter table hx_link add column sys_period_start timestamp default now();
alter table hx_link add column sys_period_end timestamp;
...
alter table hi_link add column sys_period_start timestamp default now();
alter table hi_link add column sys_period_end timestamp;
...
alter table hi_link_doc add column sys_period_start timestamp default now();
alter table hi_link_doc add column sys_period_end timestamp;
...
alter table hi_tone add column sys_period_start timestamp default now();
alter table hi_tone add column sys_period_end timestamp;
...
alter table hi_tthree add column sys_period_start timestamp default now();
alter table hi_tthree add column sys_period_end timestamp;
...
alter table hi_ttwo add column sys_period_start timestamp default now();
alter table hi_ttwo add column sys_period_end timestamp;
...
alter table hsd_setting add column sys_period_start timestamp default now();
alter table hsd_setting add column sys_period_end timestamp;
...
alter table hsd_user add column sys_period_start timestamp default now();
alter table hsd_user add column sys_period_end timestamp;
...
alter table link add column sys_period_start timestamp default now();
alter table link add column sys_period_end timestamp;
...
alter table c_user add column sys_period_start timestamp default now();
alter table c_user add column sys_period_end timestamp;
