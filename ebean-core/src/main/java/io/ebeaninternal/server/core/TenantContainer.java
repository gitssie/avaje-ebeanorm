 ...
 */
public final class TenantContainer implements SpiContainer {
  ...
  public SpiEbeanServer createServer(DatabaseConfig config) {
    ...
    try {
      ...
      InternalConfiguration c = new TenantInternalConfiguration(online, clusterManager, executor, config, bootupClasses);
